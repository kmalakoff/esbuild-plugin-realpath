...
const nodeResolve = promisify(resolve.default ?? (resolve as unknown as typeof resolve.default));
...
export default (optionsIn = {}): Plugin => {
  return {
    ...
    setup(build: PluginBuild): void {
      const cache: Record<string, () => Promise<OnResolveResult | null | undefined>> = {};
      const options = {
